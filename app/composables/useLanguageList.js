 ...
 * useLanguageList
 *
 * Returns a comprehensive map of programming-language names to their
 * official GitHub-style hex colors. Sourced from the full Linguist
 * language list so every repo language gets an accurate color dot.
 *
 * @returns {{ langColor: (lang: string) => string }}
 */
export function useLanguageList() {
  ...
  const colors = {
    ...
    'Modula-2': '#10253f',
    'Modula-3': '#223388',
    'Module Management System': '#e3d15f',
    Mojo: '#ff4c1f',
    Monkey: '#00b1ab',
    'Monkey C': '#8D6747',
    Moonscript: '#ff4585',
    ...
    Prolog: '#74283c',
    Promela: '#de0000',
    'Protocol Buffer': '#c3e4ee',
    'Protocol Buffer Text Format': '#c3e4ee',
    'Public Key': '#b5b5b5',
    Pug: '#a86454',
    Puppet: '#302B6D',
    PureBasic: '#5a6986',
   ...
   * Falls back to a neutral gray when the language isn't in the map.
   *
